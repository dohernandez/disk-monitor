...
app_id = 'local.darien.diskmonitor.spotlight-setup'
helper_id = app_id + '.scanner'
with (app / 'Contents/Info.plist').open('wb') as f:
    plistlib.dump({'CFBundleIdentifier': app_id, 'CFBundleName': 'Disk Monitor Setup', 'CFBundleExecutable': 'Preview', 'CFBundlePackageType': 'APPL', 'CFBundleVersion': BUILD_NUMBER, 'LSMinimumSystemVersion': '15.0'}, f)
...
try:
    ...
    print(run([str(macos / 'Preview'), '--check-package']).decode().strip())
